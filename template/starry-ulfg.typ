#let starry-ulfg(
  ...
  // paragraph settings
  set par(justify: true, spacing: 1.0em)
  // page settings
  set page(
    paper: paper-size,
  ...
  show heading.where(level: 1): it => { v(1.1em, weak: true); it }
  ...
  if show-table-of-contents {
    outline(title: [Table of Contents], depth: 2, indent: auto, target: heading.where(supplement: [Chapter]))
    pagebreak(weak: true)
  }
  ...
  // Abstract (rubric: page iii, after the contents and figure lists).
  if abstract != [] {
